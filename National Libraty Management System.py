...
while 1:
    ...
    try:
        ...
        if uc==1:
            ...
            for i in range(x):
                ...
                if book_n =="":
                    count-=1
                    # female=pyttsx3.init()
                    # voices = pyttsx3.getProperty('voices')
                    # female_voice = 
                    print("\t\t\tBook name can not be empty . This can create issue in searching book")
                    break
                if book_n in dic:
                    count-=1
        ...
        print("\n\t\t Invalid choice. Kindly enter your choice again between (1 to 7) according to menu")
        #continue            
# end of code        